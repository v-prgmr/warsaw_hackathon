...
| `g1_calibration` | ament_python | chessboard calibration of the chest OAK-D: intrinsics, OAK ↔ RealSense, OAK ↔ LiDAR → `torso_link -> OAK` static transform; see its README |
